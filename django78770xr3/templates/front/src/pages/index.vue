	...
	<div class="main-containers">
		<div class="body-containers">
			<div class="top-container">
				<!-- info -->
				<div class="top_title">
					<span @click="goMenu('/index/home')">大学生心理状况分析系统的设计与实现</span>
				</div>
		...
		async getSession() {
			await this.$http.get(`${localStorage.getItem('UserTableName')}/session`, {emulateJSON: true}).then(async res => {
				if (res.data.code == 0) {
					...
					if(localStorage.getItem('UserTableName')== 'xinlizixunshi') {
						localStorage.setItem('username', res.data.data.zixunshizhanghao);
					}
