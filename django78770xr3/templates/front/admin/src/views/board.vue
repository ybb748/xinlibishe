		...
		<div :style='{"padding":"20px","flex":"auto","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"0","zIndex":"2"}'>
			<div :style='{"width":"25%","padding":"0","flexDirection":"column","background":"none","display":"flex","gap":"10px"}'>
				<div class="echarts1">
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="psychologicaldataChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"padding":"0 0 0 45px","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250103/a6c3848945ee42adbb690d642254926d.png) center center/100% 100%","width":"100%","lineHeight":"40px","height":"55px"}'>
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="psychologicaldataChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts3">
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="psychologicaldataChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
				...
				<div :style='{"padding":"0 0 10px 0","margin":"0","color":"#fff","alignItems":"center","background":"none","display":"flex","gap":"10px","width":"100%","fontSize":"14px","justifyContent":"space-evenly","height":"84px"}'>
					...
					<div :style='{"margin":"0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20250104/f33d5d50e8f84eca902cf5cfcbf23edf.png) center center/100% 100%","flexDirection":"column","flex":"0 1 auto","display":"flex","width":"175px","position":"relative","justifyContent":"center","height":"100%","maxWidth":"175px"}'>
						...
						<div :style='{"padding":"0","alignItems":"center","flexDirection":"column","display":"flex","width":"100%","justifyContent":"center","height":"100%"}'>
							<div :style='{"lineHeight":"24px","fontSize":"12px","position":"relative","color":"inherit","height":"24px"}'>心理数据总数</div>
							<div :style='{"lineHeight":"24px","fontSize":"16px","color":"rgb(30, 144, 255)","fontWeight":"bold","height":"24px","order":"20"}'>{{psychologicaldataCount}}</div>
						</div>
					</div>
				</div>
				<div class="echarts7">
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="psychologicaldataChart7" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts8">
					<div :style='{"padding":"0 0 0 40px","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250103/a6c3848945ee42adbb690d642254926d.png) no-repeat left center/auto 100%","width":"100%","lineHeight":"40px","height":"55px"}'>
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="psychologicaldataChart8" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts9">
					<div :style='{"padding":"0 0 0 40px","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250103/a6c3848945ee42adbb690d642254926d.png) no-repeat left center/auto 100%","width":"100%","lineHeight":"40px","height":"55px"}'>
					...
					<el-table id="psychologicaldataTable" :data="psychologicaldataList" border :stripe="true" :style='{"padding":"0","borderColor":"#eee","overflow":"auto","borderWidth":"0","background":"none","width":"100%","borderStyle":"solid","height":"calc(100% - 65px)"}'>
						<el-table-column :resizable="true" :sortable="false" prop="studentid" label="学号">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="gender" label="性别">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="gradelevel" label="所在年级">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="professionalcategory" label="专业类别">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="scoreofmentalhealthscale" label="心理健康量表得分">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="emotionalstabilityscore" label="情绪稳定性得分">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="perceivedleveloflearningstress" label="学习压力感知程度">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="socialactivitylevel" label="社交活跃度">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="regularityofdailyroutine" label="作息规律性">
						</el-table-column>
					</el-table>
				</div>
			</div>
			<div :style='{"padding":"0","flexWrap":"wrap","flexDirection":"column","background":"none","display":"flex","gap":"10px","width":"25%"}'>
				<div class="echarts4">
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="psychologicaldataChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts5">
					<div :style='{"padding":"0 0 0 40px","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250103/a6c3848945ee42adbb690d642254926d.png) no-repeat left center/auto 100%","width":"100%","lineHeight":"40px","height":"55px"}'>
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="psychologicaldataChart5" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts6">
					<div :style='{"padding":"0 0 0 40px","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250103/a6c3848945ee42adbb690d642254926d.png) no-repeat left center/auto 100%","width":"100%","lineHeight":"40px","height":"55px"}'>
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="psychologicaldataChart6" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
	...
	export default {
		data() {
			return {
				...
				myChart0: null,
				psychologicaldataList: [],
				psychologicaldataTimer: null,
				dates: '',
				psychologicaldataCount: 0,
		...
		created() {
			this.$nextTick(()=>{
				this.times()
				setTimeout(()=>{
					this.getpsychologicaldataCount();
					this.psychologicaldataChat1();
					this.psychologicaldataChat2();
					this.psychologicaldataChat3();
					this.psychologicaldataChat4();
					this.psychologicaldataChat5();
					this.psychologicaldataChat6();
					this.psychologicaldataChat7();
					this.psychologicaldataChat8();
				},500)
			})
		},
		methods:{
			getpsychologicaldataList() {
				let params = {
					page: 1,
					limit: 20,
				}
				this.$http({
					url: "psychologicaldata/page",
					method: "get",
					params: params
				}).then(({ data }) => {
					if (data && data.code === 0) {
						this.psychologicaldataList = data.data.list;
						let div = document.getElementById('psychologicaldataTable')
						var scrollTop = -1
						function move() {
							if (div){
						...
						this.psychologicaldataTimer = setInterval(move, 2000);
						div.addEventListener('mouseenter', e => {
							e.stopPropagation()
							clearInterval(this.psychologicaldataTimer);
						})
			...
			getpsychologicaldataCount() {
				this.$http({
					url: `psychologicaldata/count`,
					method: "get"
				}).then(({
					data
				}) => {
					if (data && data.code == 0) {
						this.psychologicaldataCount = data.data
					}
				})
			},
			//统计接口1
			psychologicaldataChat1() {
				this.$nextTick(()=>{

					var psychologicaldataChart1 = echarts.init(document.getElementById("psychologicaldataChart1"),'macarons');
					this.$http({
						url: "psychologicaldata/group/gender",
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
							...
							// 使用刚指定的配置项和数据显示图表。
							psychologicaldataChart1.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								psychologicaldataChart1.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			//统计接口2
			psychologicaldataChat2() {
				this.$nextTick(()=>{

					var psychologicaldataChart2 = echarts.init(document.getElementById("psychologicaldataChart2"),'macarons');
					this.$http({
						url: "psychologicaldata/sectionStat/scoreofmentalhealthscale",
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
							...
							for(let i=0;i<res.length;i++){
								...
								xAxis.push(res[i].scoreofmentalhealthscale);
								yAxis.push(parseFloat((res[i].total)));
								pArray.push({
									value: parseFloat((res[i].total)),
									name: res[i].scoreofmentalhealthscale
								})
							}
							var option = {};
							let titleObj = this.bar.title
							titleObj.text = '健康量表得分'
							...
							// 使用刚指定的配置项和数据显示图表。
							psychologicaldataChart2.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								psychologicaldataChart2.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			//统计接口3
			psychologicaldataChat3() {
				this.$nextTick(()=>{

					var psychologicaldataChart3 = echarts.init(document.getElementById("psychologicaldataChart3"),'macarons');
					this.$http({
						url: "psychologicaldata/group/perceivedleveloflearningstress",
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
							...
							for(let i=0;i<res.length;i++){
								...
								xAxis.push(res[i].perceivedleveloflearningstress);
								yAxis.push(parseFloat((res[i].total)));
								pArray.push({
									value: parseFloat((res[i].total)),
									name: res[i].perceivedleveloflearningstress
								})
							}
							var option = {};
							...
							// 使用刚指定的配置项和数据显示图表。
							psychologicaldataChart3.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								psychologicaldataChart3.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			//统计接口4
			psychologicaldataChat4() {
				this.$nextTick(()=>{

					var psychologicaldataChart4 = echarts.init(document.getElementById("psychologicaldataChart4"),'macarons');
					this.$http({
						url: "psychologicaldata/group/socialactivitylevel",
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
							...
							for(let i=0;i<res.length;i++){
								...
								xAxis.push(res[i].socialactivitylevel);
								yAxis.push(parseFloat((res[i].total)));
								pArray.push({
									value: parseFloat((res[i].total)),
									name: res[i].socialactivitylevel
								})
							}
							var option = {};
							...
							// 使用刚指定的配置项和数据显示图表。
							psychologicaldataChart4.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								psychologicaldataChart4.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			//统计接口5
			psychologicaldataChat5() {
				this.$nextTick(()=>{

					var psychologicaldataChart5 = echarts.init(document.getElementById("psychologicaldataChart5"),'macarons');
					this.$http({
						url: "psychologicaldata/group/regularityofdailyroutine",
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
							...
							for(let i=0;i<res.length;i++){
								...
								xAxis.push(res[i].regularityofdailyroutine);
								yAxis.push(parseFloat((res[i].total)));
								pArray.push({
									value: parseFloat((res[i].total)),
									name: res[i].regularityofdailyroutine
								})
							}
							var option = {};
							let titleObj = this.bar.title
							...
							// 使用刚指定的配置项和数据显示图表。
							psychologicaldataChart5.setOption(option);


							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								psychologicaldataChart5.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			// 统计接口6
			psychologicaldataChat6() {
				this.$nextTick(()=>{

					var psychologicaldataChart6 = echarts.init(document.getElementById("psychologicaldataChart6"),'macarons');
					this.$http({
						url: "psychologicaldata/sectionStat/emotionalstabilityscore",
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
							...
							for(let i=0;i<res.length;i++){
								...
								xAxis.push(res[i].emotionalstabilityscore);
								yAxis.push(parseFloat((res[i].total)));
								pArray.push({
									value: parseFloat((res[i].total)),
									name: res[i].emotionalstabilityscore
								})
							}
							var option = {};
							let titleObj = this.line2.title
							titleObj.text = '情绪稳定性得分'
							...
							// 使用刚指定的配置项和数据显示图表。
							psychologicaldataChart6.setOption(option);


							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								psychologicaldataChart6.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			// 统计接口7
			psychologicaldataChat7() {
				this.$nextTick(()=>{

					var psychologicaldataChart7 = echarts.init(document.getElementById("psychologicaldataChart7"),'macarons');
					this.$http({
						url: "psychologicaldata/group/gradelevel",
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
							...
							for(let i=0;i<res.length;i++){
								...
								xAxis.push(res[i].gradelevel);
								yAxis.push(parseFloat((res[i].total)));
								pArray.push({
									value: parseFloat((res[i].total)),
									name: res[i].gradelevel
								})
							}
							var option = {};
							...
							// 使用刚指定的配置项和数据显示图表。
							psychologicaldataChart7.setOption(option);


							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								psychologicaldataChart7.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			// 统计接口8
			psychologicaldataChat8() {
				this.$nextTick(()=>{

					var psychologicaldataChart8 = echarts.init(document.getElementById("psychologicaldataChart8"),'macarons');
					this.$http({
						url: "psychologicaldata/group/professionalcategory",
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
							...
							for(let i=0;i<res.length;i++){
								...
								xAxis.push(res[i].professionalcategory);
								yAxis.push(parseFloat((res[i].total)));
								pArray.push({
									value: parseFloat((res[i].total)),
									name: res[i].professionalcategory
								})
							}
							var option = {};
							...
							// 使用刚指定的配置项和数据显示图表。
							psychologicaldataChart8.setOption(option);


							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								psychologicaldataChart8.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
