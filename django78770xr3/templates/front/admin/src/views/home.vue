<template>
	<div class="home-content">
		...
		<div class="statis-box">
			<div id="statis1" class="statis1 animate__animated" v-if="isAuth('psychologicaldata','首页总数')">
				<div class="left">
					<span class="icon iconfont icon-zhangjie8"></span>
				</div>
				<div class="right">
					<div class="num">{{psychologicaldataCount}}</div>
					<div class="name">心理数据总数</div>
				</div>
			</div>
		</div>
		<!-- statis -->
		...
		<!-- 5 -->
		<div class="type5">
			<div id="psychologicaldataChart1" class="echarts1 animate__animated" v-if="isAuth('psychologicaldata','首页统计')"></div>
			<div id="psychologicaldataChart2" class="echarts2 animate__animated" v-if="isAuth('psychologicaldata','首页统计')"></div>
			<div id="psychologicaldataChart3" class="echarts3 animate__animated" v-if="isAuth('psychologicaldata','首页统计')"></div>
			<div id="psychologicaldataChart4" class="echarts4 animate__animated" v-if="isAuth('psychologicaldata','首页统计')"></div>
			<div id="psychologicaldataChart5" class="echarts5 animate__animated" v-if="isAuth('psychologicaldata','首页统计')"></div>
		</div>
	</div>
</template>
<script>
...
export default {
	...
	mounted(){
		...
		if(this.isAuth('psychologicaldata','首页统计')){
	...
	methods:{
		handleScroll() {
			let arr = [
				...
				{id:'psychologicaldataChart1',css:'animate__'},
				{id:'psychologicaldataChart2',css:'animate__'},
				{id:'psychologicaldataChart3',css:'animate__'},
				{id:'psychologicaldataChart4',css:'animate__'},
				{id:'psychologicaldataChart5',css:'animate__'},
			]
...
<style lang="scss" scoped>
	.home-content {
		padding: 10px 30px;
		background: url(http://codegen.caihongy.cn/20250424/1c5e8a3994454301808d9cd66a02c935.png) no-repeat center top / cover,#f7f7f7;
		display: flex;
		width: 100%;
		min-height: 100vh;
