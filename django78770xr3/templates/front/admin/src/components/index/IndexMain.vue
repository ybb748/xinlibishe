<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0","margin":"0 0 0 64px","position":"relative","display":"block"} : {"minHeight":"100%","padding":"0px 0 0 230px","margin":"0","position":"relative","background":"#ffffff","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"boxShadow":"0 0px 0px rgba(0, 0, 0, .3)","padding":"0 20px 0","alignItems":"center","color":"#333","display":"flex","justifyContent":"flex-end","top":"0","left":"0px","background":"#ffffff","width":"calc(100% - 0px)","fontSize":"16px","position":"inherit","zIndex":"1001","height":"70px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"0","margin":"0px auto 0 30px","borderColor":"#3b6885","top":"26px","left":"230px","borderWidth":"0 0 0px 0","background":"none","width":"auto","fontSize":"16px","position":"absolute","borderStyle":"solid","zIndex":"1008"}' class="bread-crumbs"></bread-crumbs>
