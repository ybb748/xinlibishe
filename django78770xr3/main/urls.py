...
for i in os.listdir(mainDir):
    if i not in excludeList and i[-5:] == "_v.py":
        ...
        #沙箱接口
        if tableName.lower()=="psychologicaldata":
            urlpatterns.extend(
                  [
        ...
        if tableName.lower() == "psychologicaldata":
            urlpatterns.extend(
                [
                    path(r'{}/sectionStat/scoreofmentalhealthscale'.format(tableName.lower()),
                         eval("{}_v.{}_sectionStat_scoreofmentalhealthscale".format(tableName.capitalize(), tableName.lower()))),
                ]
            )
        if tableName.lower() == "psychologicaldata":
            urlpatterns.extend(
                [
                    path(r'{}/sectionStat/emotionalstabilityscore'.format(tableName.lower()),
                         eval("{}_v.{}_sectionStat_emotionalstabilityscore".format(tableName.capitalize(), tableName.lower()))),
                ]
            )
        if tableName.lower() == "psychologicaldata":
            urlpatterns.extend(
...
#好友
        ...
        if tableName.lower() == "exampaper":
            urlpatterns.extend(
                [
                    path(r'{}/compose'.format(tableName.lower()),
                         eval("{}_v.{}_compose".format(tableName.capitalize(), tableName.lower()))),
                ]
            )
        if tableName.lower() == "exampaper":
            urlpatterns.extend(
        ...
        if tableName.lower() == "examquestion":
            urlpatterns.extend(
                [
                    path(r'{}/security'.format(tableName.lower()),
                         eval("{}_v.{}_security".format(tableName.capitalize(), tableName.lower()))),
        ...
        if tableName.lower() == "examquestionbank":
            urlpatterns.extend(
                [
                    path(r'{}/security'.format(tableName.lower()),
                         eval("{}_v.{}_security".format(tableName.capitalize(), tableName.lower()))),
        ...
        if tableName.lower() == "discussxinlizixun":
            urlpatterns.extend(
                [
                    path(r'{}/security'.format(tableName.lower()),
                         eval("{}_v.{}_security".format(tableName.capitalize(), tableName.lower()))),
